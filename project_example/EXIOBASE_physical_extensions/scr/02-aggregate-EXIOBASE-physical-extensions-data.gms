...
/
$include %project%/EXIOBASE_physical_extensions/sets/model/physical_deu_model.txt
/

ude                           unused domestic extraction types
/
$include %project%/EXIOBASE_physical_extensions/sets/model/physical_ude_model.txt
/

emis                          emission types
/
$include %project%/EXIOBASE_physical_extensions/sets/model/physical_emissions_model.txt
/

land                          land use types
/
$include %project%/EXIOBASE_physical_extensions/sets/model/physical_land_model.txt
/

water                         type of water use
/
$include %project%/EXIOBASE_physical_extensions/sets/model/physical_water_cons_model.txt
$include %project%/EXIOBASE_physical_extensions/sets/model/physical_water_wd_model.txt
/
...
col_agg
/
$include %project%/EXIOBASE_physical_extensions/sets/model/physical_industries_aggregated.txt
/
...
/
$include %project%/EXIOBASE_physical_extensions/sets/aggregation/physical_deu_extensions_to_model.txt
/

ude_aggr(ude_ext,ude)         aggregation scheme for unused domestic extraction
                              # types
/
$include %project%/EXIOBASE_physical_extensions/sets/aggregation/physical_ude_extensions_to_model.txt
/
;
...
;
$libinclude xlimport emis_aggr  %project%/EXIOBASE_physical_extensions/sets/aggregation/physical_extensions_to_model.xlsx EMIS!b1:f171 ;

Sets
land_aggr(land_ext,land)      aggregation scheme for  land use types
/
$include %project%/EXIOBASE_physical_extensions/sets/aggregation/physical_land_extensions_to_model.txt
/

water_aggr(water_ext,water)   aggregation scheme for type of water use
/
$include %project%/EXIOBASE_physical_extensions/sets/aggregation/physical_water_extensions_to_model.txt
/
;
...
;
$libinclude xlimport col_ext_aggr  %project%\EXIOBASE_physical_extensions\sets\aggregation\industries_extensions_to_database.xlsx GROUPSc_use!d2:cw172 ;

Sets
col_ext_model(col_agg,*)      aggregation scheme for industries and final demand
                              # categories in physical extensions
/
$include %project%/EXIOBASE_physical_extensions/sets/aggregation/physical_industries_aggregated_to_model.txt
/

reg_ext_aggr(reg_ext,reg)     aggregation scheme for regions in physical
                              # extensions
/
$include %project%/EXIOBASE_physical_extensions/sets/aggregation/physical_regions_extensions_to_model.txt
/
;
