* File:   %project%/02_project_model_setup/scr/simulation_03_BAU_mat_reduction.gms
...
* decreases the use of product group pINDU and pMANU in each industry, and
...
* Read in productivity values from GDP loop (01_BAU_loop_fprod)
