...
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_deu_database.txt
/
ude_ext     unused domestic extraction
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_ude_database.txt
/
emis_ext    emissions
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_emissions_database.txt
/
land_ext    land use
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_land_database.txt
/
water_ext   water consumption and withdrawal
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_water_database.txt
/

unit
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_units_database.txt
/

col_ext     industries
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_industries_database.txt
/
reg_ext     regions
/
$include    %project%\EXIOBASE_physical_extensions\sets\physical_regions_database.txt
/
;
