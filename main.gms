...
Execute "if not exist 00_simulation_prepare.g00 gams library/scr/00_simulation_prepare.gms s=00_simulation_prepare o=00_simulation_prepare.lst lf=00_simulation_prepare.log lo=4 ide=1 pw=80 ps=0 --db_check=%db_check% --project=%project% --prodfunc=%prodfunc% --demnfunc=%demnfunc% --agg_check=%agg_check% --base_year=%base_year% --base_cur=%base_cur%"  ;
