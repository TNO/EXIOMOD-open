...
* File:     project_ENVLinkages\00-principal\scr\run_simulation_InternalWS.gms
...
Option decimals = 8 ;
Option nlp = conopt3 ;
CGE_step1_directeffect.scaleopt = 1 ;
Solve CGE_step1_directeffect using MCP ;
...
Execute_Unload 'results_step1_directeffect'
