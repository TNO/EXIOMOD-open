...
Execute "if not exist sp.g00 gams library/scr/00_simulation_prepare_modules.gms s=sp gdx=sp.gdx o=00_simulation_prepare_modules.lst lo=4 ide=1 pw=80 ps=0 --db_check=%db_check% --project=%project% --agg_check=%agg_check% --base_year=%base_year% --base_cur=%base_cur%"  ;
