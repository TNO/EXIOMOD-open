...
/
$include    %project%\01_external_data\physical_extensions\sets\physical_deu_database.txt
/
ude_ext     unused domestic extraction
/
$include    %project%\01_external_data\physical_extensions\sets\physical_ude_database.txt
/
water_ext   water consumption and withdrawal
/
$include    %project%\01_external_data\physical_extensions\sets\physical_water_database.txt
/
land_ext    land use
/
$include    %project%\01_external_data\physical_extensions\sets\physical_land_database.txt
/
emis_ext    emissions
/
$include    %project%\01_external_data\physical_extensions\sets\physical_emissions_database.txt
/


unit
/
$include    %project%\01_external_data\physical_extensions\sets\physical_units_database.txt
/

col_ext     industries
/
$include    %project%\01_external_data\physical_extensions\sets\physical_industries_database.txt
/
reg_ext     regions
/
$include    %project%\01_external_data\physical_extensions\sets\physical_regions_database.txt
/
;
