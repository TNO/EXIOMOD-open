...
* OE specific parameters
TOTCONS_time(regg,year)         Total consumption of all goods, by all consumers
                                # in a region
CONS_H_TT_time(regg,year)       Total consumption of all goods, by households in
                                # a region
CONS_G_TT_time(regg,year)       Total consumption of all goods, by the government
                                # in a region
INTER_USE_TT_time(regg,ind,year)   Total consumption of all goods, by industries
                                   # in a region
INTER_USE_MM_time(prd,regg,year)   Consumption of imported <this product> by
                                   # industries
INTER_USE_DD_time(prd,regg,year)   Consumption of domestic <this product> by
                                   # industries
;
